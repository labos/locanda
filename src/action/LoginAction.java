...
public class LoginAction extends ActionSupport implements SessionAware {
	...
	private void buildRooms(Structure structure) {
		...
		aRoom.setName("101");
		aRoom.addRoomFacility(this.getStructureService()
				.findRoomFacilitiesByIdStructure(structure).get(0));
		aRoom.addRoomFacility(this.getStructureService()
				.findRoomFacilitiesByIdStructure(structure).get(2));
		...
		aRoom.setName("201");
		aRoom.addRoomFacility(this.getStructureService()
				.findRoomFacilitiesByIdStructure(structure).get(1));
		aRoom.setRoomType(this.getRoomTypeService()
