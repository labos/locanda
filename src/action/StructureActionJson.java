...
public class StructureActionJson extends ActionSupport implements SessionAware {
	...
	@Actions({
		@Action(value="/uploadFacilityJ",results = {
				@Result(location="/facilities.jsp",name="success", params={
						"excludeProperties", "session,upload,uploadFileName,uploadContentType,name"
						} ),
				@Result(location="/facilities.jsp",name="error", params={
						"root","message"
				} ),
				@Result(location="/facilities.jsp",name="input", params={
						"root","message"
				} )
		})
	})
