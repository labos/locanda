...
<script>
Entity = {name: "season", 
		model: function(options){ return new Season( options );},
		collection: function(options){ return new Seasons( options );},
		editView: function(options){ return new EditSeasonView( options );},
...
<jsp:include page="templates/season.mustache.jsp" />    
