...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <script id="edit-template" type="text/x-handlebars-template">
		<form id="edit-form" class="yform json full" role="application">
        	<div class="c50l">
                <div class="c50l">
				  	...
				  	<div class="type-select">
                		...
                		<select name="birthDay" id="FormBirthDay" size="1" aria-required="true">
					  		<option selected="selected" value="{{birthDay}}"<s:property value="birthDay"/></option>
						...
						<label for="FormBirthMonth"><s:text name="birthMonth"/>:</label>
                		<select name="birthMonth" id="FormBirthMonth" size="1" aria-required="true">
					  		<option selected="selected" value="{{birthMonth}}"<s:property value="birthMonth"/></option>
						...
						<s:select label="%{getText('birthYear')}" name="birthYear" headerKey="-1" list="years" required="true"/>
					</div>
					<div class="type-text">           
			...
			zip	<option value="Fiji">Fiji</option>
