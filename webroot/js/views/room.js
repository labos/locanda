...
window.ImagesFacilitiesView = Backbone.View.extend({
     ...
     render: function () {
         $(this.el).html(Mustache.to_html(this.indexTemplate.html(), {id_room: this.idParent, id_structure:""}));
...
/*
 ...
 window.EditImagesFacilitiesView = EditView.extend({
     ...
     initialize: function () {
         this.model.bind('change', this.render, this);
        	 this.facilitiesListView = new FacilitiesListView( { collection: new RoomFacilities( )});
