...
window.AvailableStructureFacilities = Backbone.Collection.extend({
    ...
    url: function () {
        return 'rest/structureFacilities/structure/' + this.idWrapper  + this.from + this.to + '?term=' + this.term ;
    },
