...
window.StructureImages = Backbone.Collection.extend({
    model: StructureImage,
    //This is our StructureImages collection and holds our StructureImage models
    ...
    url: function () {
        return 'rest/images/checked/structure/' + this.idWrapper + this.from + this.to + '?term=' + this.term ;
    },
