...
window.Bookings = Backbone.Collection.extend({
    ...
    initialize: function (models, options) {
    	...
    	this.setFrom(0);
    	this.setTo(10);
    	this.setGuest(options.idGuest);
    	this.setTerm(null);
    },
    url: function () {
        return 'rest/bookings/structure/' + this.idWrapper +  '/search' + this.from + this.to + this.guestId +'?term=' + this.term ;
    },
    ...
    setGuest: function (guestId) {
        this.guestId = (typeof guestId === "number") ? '/guest/' + guestId : '';
    },
