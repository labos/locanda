...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		...
		<input type="hidden" name="redirect_form" value="goFindAllExtraPriceLists.action?sect=settings" />
		...
		<input type="hidden" name="priceList.items[<s:property value="#itemStatus.index"/>].id" value="<s:property value="#eachPriceListItem.id"/>"/>
          	  <tr>
          	  	<td><b><s:property value="#eachPriceListItem.extra.name"/></b> (<s:property value="#eachPriceListItem.extra.timePriceType"/>/<s:property value="#eachPriceListItem.extra.resourcePriceType"/>)</td>
